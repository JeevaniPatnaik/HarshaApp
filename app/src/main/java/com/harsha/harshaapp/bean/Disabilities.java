...
public class Disabilities {
    ...
    public void setDisabilitiesId(int disabilitiesId) {
    ...
    public String getDisabilitiesName() {
        return disabilitiesName;
    }

    public void setDisabilitiesName(String disabilitiesName) {
        this.disabilitiesName = disabilitiesName;
    }
}
