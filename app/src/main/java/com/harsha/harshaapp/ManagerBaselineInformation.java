 ...
 */
public class ManagerBaselineInformation extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_baseline_information);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                        ManagerBaselineInformation.this );
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.manager_baseline_information_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.accept){
            //Intent intent = new Intent(getApplicationContext(), AcceptBaselineInformation.class);
            //intent.putExtras(bundle);
            //startActivity(intent);
            Toast.makeText(ManagerBaselineInformation.this,"Your Baseline Information is Accepted",Toast.LENGTH_LONG).show();
        } else if(id == R.id.reject) {
            //Intent intent = new Intent(getApplicationContext(), RejectBaselineInformation.class);
            //intent.putExtras(bundle);
            //startActivity(intent);
            Toast.makeText(ManagerBaselineInformation.this,"Your Baseline Information is Rejected",Toast.LENGTH_LONG).show();
        }
