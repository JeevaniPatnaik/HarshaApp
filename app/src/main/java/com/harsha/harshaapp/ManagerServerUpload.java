 ...
 */
public class ManagerServerUpload extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    DBHandler dbHandler = new DBHandler(ManagerServerUpload.this, null, null, 1);
    Bundle bundle;
    User user = new User();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_server_upload);
